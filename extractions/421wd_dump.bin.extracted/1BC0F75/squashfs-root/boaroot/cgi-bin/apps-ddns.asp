...
<html>
	<head>
<title><%tcWebApi_get("String_Entry","BranchName","s")%> ONT - <%tcWebApi_get("String_Entry","dyDNS1Text","s")%></title>		<meta charset="utf-8">
		...
		function servermodechange()
			...
			function invalidCharCheck(object)
			{
			    ...
			    for (i = 0; i < len; i++)
			    {
					 ...
					 {
							alert('<%tcWebApi_Get_JSEscape("String_Entry","DDNSInvalidCharacter","s")%>');      	  								    	    	   		
					 		return true;
					 }
			    }
				return false;
