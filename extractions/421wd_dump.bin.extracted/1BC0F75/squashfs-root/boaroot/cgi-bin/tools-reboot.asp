...
<html>
	<head>
<title><%tcWebApi_get("String_Entry","BranchName","s")%> ONT - <%tcWebApi_get("String_Entry","RebootText","s")%></title>		<meta charset="utf-8">
...
<% end if end if %>		<div id="content">
			<form class="form-inline" METHOD="POST" ACTION="/cgi-bin/tools-reboot.asp" name="ConfigForm" id="ConfigForm" >
			...
			<div class="row row-w-100">
				<div class="widget col-sm-12">
					<header><%tcWebApi_get("String_Entry","RebootText","s")%></header>
					<div class=widget-body>
						<div class="form-group">
							<label class="text-justify mb-2" id="reboot_text"><%tcWebApi_get("String_Entry","RebootNoteText","s")%></label>
						</div>
						<div class="col-sm-12 d-flex align-items-end justify-content-end" id="reboot_btn">
							<button type="button" class="page-button small-button" onclick="Reboot();"><%tcWebApi_get("String_Entry","ButtonStartText","s")%></button>
						</div>
					</div>
				</div>
			</div>
