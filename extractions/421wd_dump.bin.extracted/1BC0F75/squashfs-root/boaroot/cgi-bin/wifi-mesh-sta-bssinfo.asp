		...
		<div class="row row-w-100">
			<div class="widget col-xs-12 col-lg-12">
				...
				<div class="widget-body">
					<fieldset>
						<legend><%tcWebApi_get("String_Entry","EasyMeshBssInfoText","s")%></legend>
