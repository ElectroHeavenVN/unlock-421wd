...
<html>
	<head>
<title><%tcWebApi_get("String_Entry","BranchName","s")%> ONT - <%tcWebApi_get("String_Entry","NAVL2Filter","s")%></title>		<meta charset="utf-8">
					...
					<fieldset>
                        ...
                        <div class="form-group col-lg-12" id="parentalcontrolnote_div">
                            <label class="input-description">
                                <p><a href="#"><i class="fa fa-exclamation-triangle"></i></a> <%tcWebApi_get("String_Entry","ParentalControlNoteText","s")%>&nbsp;<a href="/cgi-bin/fw-parentalcontrol.asp"> <%tcWebApi_get("String_Entry","ParentalControlText","s")%></a>.</p>
                            </label>
                        </div>
					</fieldset>
