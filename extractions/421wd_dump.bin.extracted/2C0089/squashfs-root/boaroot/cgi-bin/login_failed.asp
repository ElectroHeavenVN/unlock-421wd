			...
			<div class="row  justify-content-center">
				<div id="login-fail-box" class="col-xs-12 col-sm-10 col-md-7">
					<div id="single-card" class="card p-4">
						...
						<div id="body-text">
							<p><%tcWebApi_get("String_Entry","LoginFail","s")%></p>
							<p><%tcWebApi_get("String_Entry","LoginFailDefaultUser","s")%> <strong>admin</strong>. <%tcWebApi_get("String_Entry","LoginFailDefaultPass","s")%> <strong>"<%tcWebApi_get("GPON_ONU", "VendorId", "s")%>..."</strong></p>
						</div>
					</div>
				</div>
			</div>
