...
if Request_form("PostFlag") = "1" then
    ...
    TCWebAPI_commit("ParentalCtrl_template")
    TCWebApi_save();
end if
%>
<!doctype html>
<html>
	<head>
<title>Viettel ONT - <%tcWebApi_get("String_Entry","FILTERTYPE_index2","s")%></title>		<meta charset="utf-8">
		...
		<script language="JavaScript" type="text/JavaScript">
            ...
            arAddress[0]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address0","s")%>";
            arAddress[1]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address1","s")%>";
            arAddress[2]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address2","s")%>";
            arAddress[3]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address3","s")%>";
            arAddress[4]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address4","s")%>";
            arAddress[5]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address5","s")%>";
            arAddress[6]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address6","s")%>";
            arAddress[7]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address7","s")%>";
            arAddress[8]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address8","s")%>";
            arAddress[9]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry10","Address9","s")%>";
