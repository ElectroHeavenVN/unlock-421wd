...
<html>
	<head>
<title>Viettel ONT - <%tcWebApi_get("String_Entry","NavigationWiFi11acSettingsText","s")%></title>		<meta charset="utf-8">
...
<% end if %>
						...
						<fieldset id="11nMode_1_div">
							<div class="form-group" id=>
								<label class="col-lg-5" for="WLANChannelBandwidth"><%tcWebApi_get("String_Entry","ChannelBandwidthText","s")%></label>
								<div class="col-lg-5 custom-select">
