...
if Request_form("PostFlag") = "1" then
    ...
    if tcWebApi_validate("template_name=textlen|20&template_mode=options|Black|White&template_time=textlen|5&template_etime=textlen|5&template_repeat=textlen|13") = "1" then
...
<title>Viettel ONT - <%tcWebApi_get("String_Entry","ParentalControlText","s")%></title>		<meta charset="utf-8">
		...
		<script language="JavaScript" type="text/JavaScript">
            ...
            var arBindTemplate = new Array(max_rules);
            arAddress[0]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address0","s")%>";
            arAddress[1]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address1","s")%>";
            arAddress[2]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address2","s")%>";
            arAddress[3]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address3","s")%>";
            arAddress[4]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address4","s")%>";
            arAddress[5]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address5","s")%>";
            arAddress[6]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address6","s")%>";
            arAddress[7]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address7","s")%>";
            arAddress[8]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address8","s")%>";
            arAddress[9]    = "<%tcWebApi_get("ParentalCtrl_Template_Entry","Address9","s")%>";
            ...
            arBindTemplate[0]   = "<%tcWebApi_get("ParentalControl_Entry0","Template","s")%>";
            arBindTemplate[1]   = "<%tcWebApi_get("ParentalControl_Entry1","Template","s")%>";
            arBindTemplate[2]   = "<%tcWebApi_get("ParentalControl_Entry2","Template","s")%>";
            arBindTemplate[3]   = "<%tcWebApi_get("ParentalControl_Entry3","Template","s")%>";
            arBindTemplate[4]   = "<%tcWebApi_get("ParentalControl_Entry4","Template","s")%>";
            arBindTemplate[5]   = "<%tcWebApi_get("ParentalControl_Entry5","Template","s")%>";
            arBindTemplate[6]   = "<%tcWebApi_get("ParentalControl_Entry6","Template","s")%>";
            arBindTemplate[7]   = "<%tcWebApi_get("ParentalControl_Entry7","Template","s")%>";
            arBindTemplate[8]   = "<%tcWebApi_get("ParentalControl_Entry8","Template","s")%>";
            arBindTemplate[9]   = "<%tcWebApi_get("ParentalControl_Entry9","Template","s")%>";
